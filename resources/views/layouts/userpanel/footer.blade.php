                    ...
                    <div class="text-widget mt-50">
                        ...
                        <div class="text-content">
                            <div class="single-text">
                                <p>DUBAI MARINA <br> AS, 11444</p>
                            </div>
                            <div class="single-text">
                                <p>
                                    <span><a href="mailto:support@faroma.com">support@faroma.com</a></span>
                                    <span><a href="tel:00971557419989">+971557419989</a></span>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="footer-text-wrapper d-flex flex-wrap align-items-center justify-content-between">
                <div class="footer-copyright">
                    <p>&copy; 2021 <span> Faroma </span> Made with <i class="fa fa-heart"></i> by <a href="#">IT JAY</a></p>
                </div>
