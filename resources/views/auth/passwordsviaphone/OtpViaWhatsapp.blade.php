                ...
                <div class="login-card">
                    ...
                    <div>
                        ...
                        <div class="login-main">
                            ...
                            <form class="theme-form" action="{{ route('Send.Otp.via.whatsapp') }}" method="POST">
                                @csrf
                            ...
                            <div class="mt-4 mb-4"><span class="reset-password-link">If don't receive OTP? <a class="btn-link text-danger" href="{{ route('resend.otp') }}"
                                    ...
                                    <form id="resendotp-form" action="{{ route('resend.otp.via.whatsapp') }}" method="POST" class="d-none">
                                        @csrf
                                    </form></span></div>
                            <form id="otp-form" method="POST" action="{{ route('verify.otp.via.whatsapp') }}">
                                @csrf
                            ...
                            <form action="{{ route('password.reset.via.whatsapp') }}" method="POST">
                                @csrf
                                <div class="form-group">
