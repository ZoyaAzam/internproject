...
class PhoneVerificationController extends Controller
{
    ...
    {
        return view('auth.passwordsviaphone.PasswordViaSMS');
    }
    ...
    public function verifyPhoneNumber(Request $request)
    {
        ...
        try {
            ...
            if ($isValid) {
                ...
                return redirect()->route('password.request.via.SMS')->with('message','OTP sent successfully. OTP is valid for ten minutes' .$otp);;
            } else {
    ...
    public function resendOtp()
    {
        ...
        $user->otp_expires_at = now()->addMinutes(10);
        $user->update();
        return redirect()->route('password.request.via.SMS')->with(['message' => 'OTP has been resent.'], 200);;
    }
    public function verifyOtp(Request $request)
    {
        ...
        if ($user->otp == $otp ) {
            ...
            return redirect()->route('password.request.via.SMS');
           } else
           {
